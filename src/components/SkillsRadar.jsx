...
export default function SkillsRadar() {
  return (
    <div className="bg-white/10 dark:bg-slate-950/80 backdrop-blur-md p-2 sm:p-6 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 relative overflow-hidden group hover:border-indigo-500 transition-colors duration-500 w-full max-w-sm mx-auto aspect-square flex flex-col justify-center">
      ...
      <h3 className="text-slate-800 dark:text-white text-center font-bold mb-2 font-mono tracking-widest uppercase text-xs">Expertise Profile <span className="text-[10px] text-slate-500">(Hrs)</span></h3>
