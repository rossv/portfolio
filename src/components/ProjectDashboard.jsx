            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full">
                ...
                <div className="lg:col-span-7 xl:col-span-8 relative flex flex-col h-full bg-transparent rounded-2xl overflow-hidden">
                    ...
                    <div className="relative flex-1 min-h-0">
                        <div ref={scrollContainerRef} className="h-full overflow-y-auto p-4 md:p-6 scroll-smooth bg-transparent relative custom-scrollbar">
                        ...
                        {/* Soft rails make the top and bottom limits of the card viewport legible. */}
                        <div aria-hidden="true" className="project-scroll-edge project-scroll-edge--top hidden lg:block" />
                        <div aria-hidden="true" className="project-scroll-edge project-scroll-edge--bottom hidden lg:block" />
                    </div>
