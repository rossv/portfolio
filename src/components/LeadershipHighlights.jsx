  ...
  const renderRoleDetails = (role) => (
    ...
    >
      <img
        ...
        className="absolute inset-0 h-full w-full object-cover opacity-35 dark:opacity-30"
      />
      <div className="absolute inset-0 bg-gradient-to-br from-white/94 via-white/82 to-cyan-100/72 dark:from-slate-900/96 dark:via-slate-900/86 dark:to-indigo-900/58" />
      <div className="absolute inset-0 bg-gradient-to-t from-white/92 via-white/55 to-white/20 dark:from-slate-900/88 dark:via-slate-900/40 dark:to-slate-900/10" />
