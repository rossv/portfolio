            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                <div className="mt-8 flex justify-center gap-8 items-center">
                    <a
                        ...
                        className="text-slate-500 dark:text-slate-300 hover:text-[#1E5397] transition-all duration-300 transform hover:scale-110 bg-white/80 dark:bg-slate-900/70 ring-1 ring-slate-200/70 dark:ring-slate-700/70 shadow-sm hover:shadow-lg rounded-full p-3"
                    ...
                    <a
                        ...
                        className="text-slate-500 dark:text-slate-300 hover:text-[#0A66C2] transition-all duration-300 transform hover:scale-110 bg-white/80 dark:bg-slate-900/70 ring-1 ring-slate-200/70 dark:ring-slate-700/70 shadow-sm hover:shadow-lg rounded-full p-3"
                        aria-label="LinkedIn"
                    >
                    ...
                    <a
                        ...
                        className="text-slate-500 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-300 transform hover:scale-110 bg-white/80 dark:bg-slate-900/70 ring-1 ring-slate-200/70 dark:ring-slate-700/70 shadow-sm hover:shadow-lg rounded-full p-3"
                        aria-label="GitHub"
                    >
                    ...
                    <a
                        ...
                        className="text-slate-500 dark:text-slate-300 hover:text-[#007AC2] transition-all duration-300 transform hover:scale-110 bg-white/80 dark:bg-slate-900/70 ring-1 ring-slate-200/70 dark:ring-slate-700/70 shadow-sm hover:shadow-lg rounded-full p-3"
