                ...
                <div className="mt-8 flex flex-col items-center gap-3">
                    ...
                    <div className="flex justify-center gap-8 items-center rounded-full bg-white/70 px-4 py-3 shadow-sm ring-1 ring-slate-200/60 dark:bg-slate-900/60 dark:ring-slate-700/60">
                        ...
                        <a
                            ...
                            className="text-slate-500 dark:text-slate-300 hover:text-[#007AC2] transition-all duration-300 transform hover:scale-110 bg-white/80 dark:bg-slate-900/70 ring-1 ring-slate-200/70 dark:ring-slate-700/70 shadow-sm hover:shadow-md rounded-full p-3"
